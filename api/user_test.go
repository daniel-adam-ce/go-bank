...
func randomUserWithPassword(t *testing.T, password string) (db.User, string) {
...
func TestLoginUserAPI(t *testing.T) {
	userPassword := util.RandomString(8)

	user, hashedPassword := randomUserWithPassword(t, userPassword)
